...
Gemini's answers are still constrained to the retrieved evidence and pass
a strict local coverage/grounding check before being used.
"""
...
class GeminiGenerator:
    """Use Gemini as the primary grounded generator, never as the safety router."""
    ...
    def generate(self, query: str, evidence: str, lang: str) -> str:
        ...
        payload = {
            ...
            "generationConfig": {
                # Sampled, not near-greedy: repeated identical questions should not read back
                # the same canned phrasing. Grounding stays enforced by _validated_answer below,
                # so higher temperature buys wording variety, not factual drift.
                "temperature": 0.75,
                "maxOutputTokens": 900,
                "responseMimeType": "application/json",
                "responseSchema": {
